...
static const unsigned char AFUNDOU[] PROGMEM = {"AFUNDOU!!!!\0"};
...
static const unsigned char JOGO_CONTINUA[] PROGMEM = {"Jogo continua\0"};
...
static const unsigned char BARCO_NAO_AFUNDOU[] PROGMEM = {"NAO afundou!!\0"};
